...
const Button = styled.button.attrs(props => ({
    ...
    box-shadow: 0 0 0 0 ${props => props.mainColor || props.theme.mainColor || '#535353'},
    inset 0 0 200px 28px ${props => props.mainColor || props.theme.mainColor || '#535353'};
  ...
  &:hover {
    box-shadow: 0 0 40px 0 ${props => props.mainColor || props.theme.mainColor || '#535353'},
    inset 0 0 25px 0 ${props => props.mainColor || props.theme.mainColor || '#535353'};
...
export default function Glow({ txtColor, txt, mainColor, secondColor, fontSize, fontFamily }) {
